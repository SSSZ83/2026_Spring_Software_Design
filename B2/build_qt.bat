...
"D:\Anaconda\Library\bin\qmake.exe" B2_qt.pro -spec win32-msvc
if %ERRORLEVEL% neq 0 (
...
echo.
echo ============================================
echo   SUCCESS: telecom_billing_qt.exe built!
echo   Run: release\telecom_billing_qt.exe
echo ============================================
